...
{
	var x=document.form["frmLogCall"]["callerName"].value;
	if (x==null || x=="")
	{
...
{
	// create an associative array of $incidentType {IncidentTypeId,}
...
<form name="frmLogCall" method="post"
	...
	<tr>
		...
		<td><select name="incidentType" id ="incidentType">
				<?php 
				// populate a combo box with $incidentType
	...
	<tr>
		<td><input type="reset" name="btnCancel" value="Reset">
		</td>
